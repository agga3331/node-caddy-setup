...
[program:dnsproxy]
command = /usr/bin/dnsproxy -l 127.0.0.1 -p 53 -u https://rudn.marss.vip/dns-query -b 186.246.0.187:53
user = root
autostart = true
autorestart = true
...
dnsproxy -l 127.0.0.1 -p 53 -u https://rudn.marss.vip/dns-query -b 186.246.0.187:53 &
